...
namespace gebzedemo.Controllers
{
    ...
    {
        ///authentication
        SqlConnection con = new SqlConnection("Data Source=DESKTOP-CBI4LGI;Database=gezgebze; User ID=sa;Password=enesusta; Integrated Security=True");
        ...
        public void DeleteEmployee(int id)
        {
            ...
            using (SqlConnection con = new SqlConnection("Data Source=DESKTOP-CBI4LGI;Database=gezgebze; User ID=sa;Password=enesusta; Integrated Security=True"))
            {
